...
<div class="form-group"> 
<select name="board"><option value="select board">select board</option><option value="state">state</option><option value="CBSE">CBSE</option><option value="ICSE">ICSE</option><option value="IGCSE">IGCSE</option><option value="Others (if any)">Others (if any)</option></select>
</div>
...
<div class="form-group"> 
<textarea  name="about_school" placeholder="About school"></textarea>
</div>

<div class="form-group"> 

<select  name="ownership_type"><option value="">select ownership type</option><option value="Public">Public</option><option value="Private">Private</option><option value="Public Private Partnership">Public Private Partnership</option></select>  

</div>

<div class="form-group"> 
<select name="organization_type"><option value="">select organization</option><option value="Co-Ed">Co-Ed</option><option value="Only Girls">Only Girls</option><option value="only Boys">only Boys</option></select>   
</div>
