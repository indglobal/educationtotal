<div class="col-sm-1 left_cont">
				<ul class="nav nav-tabs">
					<li class="active"><a  href="<?php echo base_url();?>user/provider_panel"><img src="<?php echo base_url();?>user_panel_design/images/profile.png" alt="profile"><p>Profile</p></a></li>
