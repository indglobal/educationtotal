		...
		<div class="row main_face">
			<div class="col-sm-1 left_cont">
				<ul class="nav nav-tabs">
					...
					<li><a data-toggle="tab" href="<?php echo base_url();?>service/service"><img src="http://115.118.113.154/edutotal/wp-content/uploads/2015/10/download.png" alt="profile"><p> Add Service</p></a></li>
